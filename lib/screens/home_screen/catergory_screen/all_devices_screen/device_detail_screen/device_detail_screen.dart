...
class DeviceDetailScreen extends StatefulWidget {
  const DeviceDetailScreen(this.allDevices, {Key? key}) : super(key: key);
...
class _DeviceDetailScreenState extends State<DeviceDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<AllDevicesCubit, AllDevicesState>(
          ...
          return LoadingScreenAnimation(
            ...
            child: SafeArea(
              ...
              body: Padding(
                ...
                child: Column(
                  children: [
                    Image.network("${ApiConstants.baseUrl}${widget.allDevices.pics?.first}", height: 100),
                    const SizedBox(
                      height: 20,
                    ),
                    Row(
                      ...
                      onPressed: () {
                        ...
                        if (_nameTextController.text.isEmpty) {
                          ...
                          if (registrationAddress.isNotEmpty) {
                            context.read<AllDevicesCubit>().orderDevice(
                                productId: widget.allDevices.id!,
