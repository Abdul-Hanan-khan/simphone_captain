...
import 'package:sim_phone_captain/screens/home_screen/catergory_screen/sims_no_screen/sim_types_screen/sim_types_screen.dart';

import 'all_devices_screen/all_devices_screen.dart';
import 'all_phone_screen/all_phone_screen.dart';
                  ...
                  onTap: () {
                    if (name[index] == "SIMS") {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SimTypeScreen(widget.name),
                          ));
                    }
