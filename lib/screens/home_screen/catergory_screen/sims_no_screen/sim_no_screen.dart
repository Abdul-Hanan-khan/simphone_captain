...
import 'package:sim_phone_captain/screens/home_screen/catergory_screen/sims_no_screen/sim_detail_screen/sim_detail_screen.dart';
              ...
              child: SafeArea(
                ...
                body: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    // if (allSims[index].sims![i].network == widget.name) {
                    // if (allSims[index].sims!.) {
                      return Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Row(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      CircleAvatar(
                                          child: Image.asset("assets/images/delivery-bike.png", height: 25), backgroundColor: Colors.white10),
                                      const SizedBox(
                                        width: 10,
                                      ),
                                      Text(
                              ...
                              for (int i = 0; i < allSims[index].sims!.length; i++)
                                (allSims[index].sims![i].network == widget.name.toLowerCase())
                                    ? Padding(
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                (allSims[index].sims![i].discount != 0)
                                                    ? Text(
                                                      ...
                                                      children: [
                                                        (allSims[index].sims![i].discount != 0)
                                                            ...
                                                            : Text(
                                                                "${allSims[index].sims![i].price} PKR",
                                                                style:
                                                                    const TextStyle(fontWeight: FontWeight.bold, color: Colors.orange, fontSize: 16),
                                                              ),
                                                        (allSims[index].sims![i].discount != 0)
                                                            ? Text(
                                            ...
                                            (allSims[index].sims![i].available == true)
                                                ? ElevatedButton(
                                                    style: ButtonStyle(
