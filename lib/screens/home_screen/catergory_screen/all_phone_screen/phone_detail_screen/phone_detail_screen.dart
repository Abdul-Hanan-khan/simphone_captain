...
class PhoneDetailScreen extends StatefulWidget {
  const PhoneDetailScreen(this.allDevice, {Key? key}) : super(key: key);

  final Mobiles allDevice;
...
class _PhoneDetailScreenState extends State<PhoneDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<AllPhonesCubit, AllPhonesState>(
          ...
          return LoadingScreenAnimation(
            ...
            child: SafeArea(
              ...
              body: Padding(
                ...
                child: Column(
                  children: [
                    Image.network("${ApiConstants.baseUrl}${widget.allDevice.pics?.first}", height: 100),
                    const SizedBox(
                      height: 20,
                    ),
                    Row(
                      ...
                      onPressed: () {
                        ...
                        if (_nameTextController.text.isEmpty) {
                          ...
                          if (registrationAddress.isNotEmpty) {
                            context.read<AllPhonesCubit>().orderMobile(
                                productId: widget.allDevice.id!,
