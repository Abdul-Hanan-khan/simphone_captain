...
class _WalkthroughScreenState extends State<WalkthroughScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<OnbordingData> list = [
      ...
      // ),
      OnbordingData(
        image: const AssetImage("assets/images/222222.jpg"),
        imageHeight: size.height * 0.5,
        imageWidth: size.width * 0.9,
        fit: BoxFit.contain,
        descPadding: EdgeInsets.symmetric(horizontal: size.width * 0.05),
        titleText: Text(
          "Captain's Access",
      ...
      OnbordingData(
        image: const AssetImage("assets/images/Hand-thumb-up-clipart-transparent.png"),
      ...
      OnbordingData(
        image: const AssetImage("assets/images/sim.png"),
        imageHeight: size.height * 0.5,
        imageWidth: size.width * 0.8,
        fit: BoxFit.contain,
        descPadding: EdgeInsets.symmetric(horizontal: size.width * 0.05),
